 ...
 */
export function HeroScene({ image, kicker, title, lead, text, actions, veilOpacity = 0.5 }: Props) {
  ...
  return (
    <section
      ...
      data-hero
      style={
        { "--veil": "var(--color-cafe)", "--veil-opacity": veilOpacity } as React.CSSProperties
      }
    >
      ...
      <div className="scene-content container-site">
        <div className="max-w-4xl">
          ...
          {lead ? <p className="hero-lead mt-8">{lead}</p> : null}
