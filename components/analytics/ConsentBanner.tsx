  ...
  return (
    ...
    >
      <div className="container-site">
        <div className="mx-auto flex max-w-3xl flex-col gap-4 rounded-2xl border border-bege-escuro bg-branco p-5 shadow-[0_12px_40px_-12px_rgba(85,47,34,0.35)] sm:flex-row sm:items-center sm:justify-between">
          <p className="text-base">
            <strong className="font-semibold">Cookies e medição.</strong> Este site usa cookies para medir visitas e
            para anúncios do Kaluanã. Você escolhe.{" "}
