...
| Acessibilidade: contraste sobre foto  | Feito                                                             | 93 textos por fase, nenhum abaixo do mínimo (menor 5,68:1); eram 19 abaixo antes do véu; `contraste-cenas-pre.json` e `contraste-cenas-full.json`                                         |
...
| Acessibilidade: teclado               | Feito                                                             | 42 percursos em cada fase (751 paradas na `pre`, 1.568 na `full`) e 12 roteiros, todos aprovados                                                                                          |
...
5. **Texto sobre foto:** o axe não mede contraste sobre imagem. O `qa:contraste`, novo, mediu os textos claros das cenas e achou 19 de 93 abaixo do mínimo na fase `full`. Por escolha do responsável, um véu escuro desfocado fica só atrás de cada bloco de texto, e a foto segue clara no resto (decisões 111 e 112).
